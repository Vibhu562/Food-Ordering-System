  ...
  return (
   ...
   <div className='col-md-5 card p-3 shadow p-3 mb-5 bg-white rounded' style={{marginTop: '100px'}}>
        <div className='div' onSubmit={register}>
            ...
            <input type = "text" placeholder='Full Address' className='form-control' value = {Address} required onChange = {(e)=>{setaddress(e.target.value)}} />
            <input type = "number" placeholder='Enter 4 digit random otp for verification' className='form-control' value = {otp} required onChange = {(e)=>{setotp(e.target.value)}} />
